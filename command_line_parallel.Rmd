---
title: "importing and cleaning data in parallel with command line"
...
We're going to get the temperature of som capitals around the whole world using the **Open Weather Map API**
...
2) **parallel -j400% --progress -C 'curl -s "http://api.openweathermap.org/data/2.5/weather?q={}&appid=17201c85f66369c680dcbf19352f3530"'**
